...
export type ContentMode = 'media_only' | 'media_text' | 'media_text_links' | 'media_text_links_mentions' | 'original' | 'replace_links_mentions'
...
export interface CloneJob {
  ...
  mention_replace_text: string | null
  notes: string | null
}
